...
const About = () => {
    ...
    return(
        <div className="bg-[#e6e7e7] w-full p-20">
            <div className="text-black max-w-[800px] p-5 w-full mx-auto text-center flex flex-col justify-top">
                <h1 className="lg:text-5xl md:text-4xl sm:text-3xl text-3xl font-bold">Your Solution in Every Product.</h1>
            </div>
            <div className="max-w-[1200px] w-full flex md:flex-row flex-col mx-auto gap-2 mt-20">
