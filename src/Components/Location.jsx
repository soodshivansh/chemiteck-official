    ...
    return(
        <div className="h-[70%] p-10 flex items-center justify-center overflow-hidden md:flex-row flex-col text-white" id="contact-us">
            <div className="p-10 md:w-[50%] h-[45vh] bg-[#212e56] text-left w-[100%]">
                <h1 className="lg:text-4xl md:text-4xl sm:text-3xl text-2xl mb-5">Location<hr style={{ height: "0.5vh", backgroundColor: "white" }}/></h1>
                <p className="sm:text-xl"><strong>Address:</strong> RTG-82, Shipra Royal Tower market, Indirapuram, Ghaziabad, UP - 201014</p>
                <p className="sm:text-xl"><strong>Phone:</strong><br/><i class="fa-solid fa-square-phone"></i> +91 9560391635<br/> <i class="fa-solid fa-square-phone"></i> +91 9289381979</p>
            </div>
