...
const Articles = () => {
    ...
    return(
        <div id="articles" className="text-white flex flex-col md:h-[100vh] h-[70vh] lg:pt-28 lg:pr-28 lg:pl-36 pt-16 pr-16 pl-16 lg:gap-20 gap-10 w-full overflow-hidden">
